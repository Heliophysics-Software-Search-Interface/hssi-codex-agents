...
this skill directory.** Read `<repo-root>/resource_submission_form_fields.md` directly; the path is
relative to the repo root, not to this skill's base directory.
